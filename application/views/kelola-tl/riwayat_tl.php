          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>
                  <a href="<?php echo base_url(); ?>administrator/list_pmr_operator"><button type="button" class="btn btn-xs btn-default"><i class="fa fa-mail-reply"></i></button></a>
                  Pemeriksaaan <small>Regional</small>
                </h3>
              </div>
                  ...
                  <div class="x_content">
                    ...
                    ?> 
                      ...
                      <tr>
                        ...
                        <?php if ($limit < 3 AND $row['rekomendasi_status']!="Sesuai"){ ?>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        foreach ($tl as $baris) {
                          ...
                          if ($baris['tl_status']=="Belum Sesuai") {
                            $status = "<span class='btn btn-warning btn-xs btn-round'>".$baris['tl_status']."</span";
                          }
                          if ($baris['tl_status']=="Tidak dapat di Tindak Lanjuti") {
