        ...
        <div class="">
          <div class="page-title">
            <div class="title_left">
              <h3>Pemeriksaan Regional dan Divisi</h3>
            </div>
          </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>
                     <?php 
                      echo "<a href='".base_url()."administrator/list_pmr_operator'"?>
                      <button class="btn btn-xs btn-default" type="button"><i class="fa fa-mail-reply"></i> </button>
                      </a>
                    List Tindak Lanjut <small>(Operator)</small>
                  </h2>
                    ...
                    <div class="form-group">
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        <table class="table table-responsive">
                          ...
                          <tr>
                            <th style="width: 15%">Deadline Rekomendasi</th>
                            <td>
                              : <span class="btn btn-xs btn-warning"><h4><?php echo $baris['rekomendasi_tgl_deadline']; ?></h4></span>
                            </td>
                          </tr>
                        <?php }?>
                        </table>
                        ...
                        <div class="table-responsive">
                          <table id="datatable" class="table table-bordered">
                            ...
                            <tbody>
                              ...
                              if ($row['tl_publish_verif']=='Y' AND $row['tl_publish_spi']=='N') {
                                $kirim = "Terkirim ke Verifikator";
                              }elseif($row['tl_status_from_vrf']=='Y'){
                                $kirim = "Dikembalikan oleh Verifikator";
                              }elseif($row['tl_status_from_spi']=='Y'){
                                $kirim = "Dikembalikan oleh SPI";
                              }elseif ($row['tl_publish_verif']=='Y' AND $row['tl_publish_spi']=='Y') {
                                $kirim = "Terkirim ke Verifikator dan SPI";
                              ...
                              <tr>
                                ...
                                <?php }elseif ($row['status_tanggapan']=='1' && $row['tl_status']!='Sesuai' && $row['tl_status_cache']!='Sesuai') { ?>
                                <div class="form-group">
                                    <?php   echo "<a href='".base_url()."administrator/edit_tl/$id_pmr/$id_temuan/$id_rekom/$row[tl_id]'>" ?><button type="button" class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="top" title="Edit Tindak Lanjut" <?php  echo strpos($role[0]['role_akses'],'13')!==FALSE?"":"disabled"; echo $disable;?>><span class="fa fa-edit"></span> Edit</button></a>
                                    <?php   echo "<a href='".base_url()."administrator/delete_tl/$id_pmr/$id_temuan/$id_rekom/$row[tl_id]'"?><button type="button" class="btn btn-danger btn-xs" onclick="return confirm('Apa anda yakin untuk hapus Tindak Lanjut ini?')" data-toggle="tooltip" data-placement="top" title="Hapus Tindak Lanjut" <?php  echo strpos($role[0]['role_akses'],'14')!==FALSE?"":"disabled"; echo $disable; ?>><span class="fa fa-trash"></span> Hapus</button></a>
                                  </div>
