              ...
              <div class="x_panel">
                <div class="x_title">
                  <h2>
                    ...
                    Edit Tindak Lanjut <small>(SPI)</small></h2>
                ...
                <div class="x_content">
                 ...
                 <?php 
                  ...
                  echo form_open_multipart('administrator/edit_tl_spi/'.$id_pmr.'/'.$id_temuan.'/'.$id_rekom,$attributes); 
                  ...
                  foreach ($record as $row) { 
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-8 col-sm-8 col-xs-12">
                       <textarea id="mytextarea" name="tl" class="resizable_textarea form-control" rows="8"><?php echo $row['tl_deskripsi']; ?></textarea>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-8 col-sm-8 col-xs-12">
                        <select name="status" id="status" class="form-control">
                          ...
                          <option value="Sudah di Tindak Lanjut" <?php if ($row['tl_status']=="Sudah di Tindak Lanjut") {echo "selected";}?>>Sudah di Tindak Lanjut</option>
                          <option value="Sudah TL (Belum Optimal)" <?php if ($row['tl_status']=="Sudah TL (Belum Optimal)") {echo "selected";}?>>Sudah di Tindak Lanjut (Belum Optimal)</option>
                          <option value="Belum di Tindak Lanjut" <?php if ($row['tl_status']=="Belum di Tindak Lanjut") {echo "selected";}?>>Belum di Tindak Lanjut</option>
                          <option value="Dikembalikan" <?php if ($row['tl_status']=="Dikembalikan") {echo "selected";}?>>Dikembalikan</option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group">
	                    <label class="control-label col-lg-3">List File Tindak Lanjut
