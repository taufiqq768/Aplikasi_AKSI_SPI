              ...
              <div class="x_panel">
                <div class="x_title">
                  <h2>
                    ...
                    Tambah Tindak Lanjut <small>(Petugas Regional)</small></h2>
                ...
                <div class="x_content">
                  <div class="table-responsive"> 
                      ...
                      <tr>
                        <th style="width: 150px; vertical-align: top;">Rekomendasi</th>
                  ...
                  <?php 
                    ...
                    echo form_open_multipart('administrator/input_tl/'.$id_pmr.'/'.$id_temuan.'/'.$id_rekom,$attributes);
                  ?>
                    <div class="form-group">
                      <label class="control-label col-md-2 col-sm-2 col-xs-12">Tanggal Tindak Lanjut</label>
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-2 col-sm-2 col-xs-12" >Link Dokumen Pendukung <span class="required">*</span>
                      </label>
                      <div class="col-md-8 col-sm-8 col-xs-12">
                   ...
                   <!-- muncul setelah SPI memberi status -->
                    ...
                    <div class="form-group">
                      <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-5">
                        ...
                        <button type="submit" name="submit" class="btn btn-primary">Simpan Draft</button>
                        <button type="submit" name="kirim" class="btn btn-success">Kirim ke Verifikator</button>
                      </div>
                    </div>
