<title>PTPN XII | Upload File Tanggapan </title>
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  <div class="table-responsive"> 
                      ...
                      ?>
                      <tr>
                        <th style="width: 150px; vertical-align: top;">Tanggapan Manajer</th>
                        <td>: <?php 
                        $tanggapan = $this->model_app->view_where('tb_tanggapan','tanggapan_id', $id_tanggapan);
                  ...
                  <div class="form-group">
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        echo "<a href='".base_url()."administrator/list_tanggapantl/$id_pmr/$id_temuan/$id_rekom'>" ?><button type="button" class="btn btn-primary pull-right">Done</button></a>
                      </div>
                  </div>
  ...
  <?php $id_pmr = $this->uri->segment(3); $id_temuan = $this->uri->segment(4);
   ...
   <script type="text/javascript">
    ...
    var BASE_URL = "<?php echo base_url('administrator/uploadfile_tanggapan/');?>";
    var redirect = "<?php echo base_url('administrator/list_tanggapantl/');?>";
    var foto_upload= new Dropzone(".dropzone",{
    url: BASE_URL+id_pmr+'/'+id_temuan+'/'+id_rekom+'/'+id_tanggapan,
    maxFilesize: 50,
    method:"post",
    maxFiles: 10,
    ...
    success: function(data, textStatus) {
        if (data.redirect) {
            ...
            window.location.href = redirect+id_pmr+'/'+id_temuan+'/'+id_rekom+'/'+id_tanggapan;
        }
    }
    });
