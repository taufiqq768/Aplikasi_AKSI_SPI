        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-9 col-sm-9 col-xs-12">
              <div class="x_panel">
                  <div class="x_title">
                    <h2>Form Edit Bidang <small></small></h2>
                  ...
                  <?php 
                    ...
                    echo form_open('administrator/edit_bidang/'.$this->uri->segment(3),$attributes);
                  ?>
                      <?php foreach ($record as $row) { 
                        echo "<div class='form-group'><input type='hidden' name='id' value='$row[bidangtemuan_id]'></div>";
                      ?>
                      
                      <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Bidang <span class="required ">*</span></label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="bidang" required="required" name="bidang" class="form-control col-md-7 col-xs-12" value="<?php echo $row['bidangtemuan_nama'] ?>">
                      </div>
                      </div>
                        <?php } ?>
