        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-9 col-sm-9 col-xs-12">
              <div class="x_panel">
                  <div class="x_title">
                    <h2>Form Edit Penyebab <small></small></h2>
                  ...
                  <?php 
                    ...
                    echo form_open('administrator/edit_sebab/'.$this->uri->segment(3),$attributes);
                  ?>
                      <?php foreach ($record as $row) { 
                        echo "<div class='form-group'><input type='hidden' name='id' value='$row[sebab_id]'></div>";
                      ?>
                      
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Kode <span class="required ">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="kode" required="required" name="kode" class="form-control col-md-7 col-xs-12" value="<?php echo $row['sebab_kode'] ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Penyebab <span class="required ">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="sebab" required="required" name="sebab" class="form-control col-md-7 col-xs-12" value="<?php echo $row['klasifikasi_sebab'] ?>">
                        </div>
                      </div>
                        <?php } ?>
