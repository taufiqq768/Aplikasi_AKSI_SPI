              ...
              <div class="x_content">
                ...
                <div class="table-responsive"> 
                  ...
                  <?php 
                    ...
                    echo form_open('administrator/multikirimrekom_tokebun/'.$id_pmr,$atribut); 
                  ?>
                  <button type="submit" name="kirim" class="btn btn-xs btn-success" <?php echo $disable2; ?>><span class="fa fa-send"></span> Approve</button>
                  <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    ...
                    <div id="myTabContent" class="tab-content">
                      ...
                      <div role="tabpanel" class="tab-pane <?php echo $aktif2 ?>" id="tab_content<?php echo $nilai['bidangtemuan_id']?>" aria-labelledby="home-tab">
                        <div class="table-responsive">
                          <h5><strong><?= $nilai['bidangtemuan_nama']?></strong></h5>
                          <table class="table table-bordered table-striped datatable">
                            ...
                            <tbody>
                              ...
                              $temuan = $this->db->query("SELECT * FROM tb_rekomendasi JOIN tb_temuan ON tb_rekomendasi.temuan_id = tb_temuan.temuan_id WHERE bidangtemuan_id='$id_bidang' AND rekomendasi_publish_kabag='Y' AND tb_temuan.pemeriksaan_id = '$id_pmr' ORDER BY tb_temuan.temuan_id")->result_array();
                              $no = 1;
                              ...
                              <tr>
                                ...
                                <td>
                                  <?php if ($row['rekomendasi_kirim']=="Y"):
                                        echo "<center><span class='green'>Telah disetujui</span></center>";
                                        else: 
                                        echo "<center><span class='red'>Belum disetujui</span></center>";
                                        endif
                                  ?>
                                </td>
                                <td>
                                    <?php if ($row['rekomendasi_kirim']=="N"): ?>
                                    <center>  
                                      <a href="<?php echo base_url(); ?>administrator/kembalikan_rekomendasi/<?php echo $row['pemeriksaan_id']?>/<?php echo $row['temuan_id']?>/<?php echo $row['rekomendasi_id']?>"><button type="button" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="top"  title="Kembalikan Temuan Rekomendasi ke SPI" <?php echo $disable2; ?>><i class="fa fa-mail-reply"></i></button></a>
                                      <a href="<?php echo base_url(); ?>administrator/kirim_rekomendasi/<?php echo $row['pemeriksaan_id']?>/<?php echo $row['temuan_id']?>/<?php echo $row['rekomendasi_id']?>"><button type="button" class="btn btn-success btn-xs" data-toggle="tooltip" data-placement="top" title="Approve Temuan Rekomendasi" <?php echo $disable2; ?>><i class="fa fa-send"></i> Kirim</button></a>
                                    </center>
                                    <?php endif ?>
                                  <center>
