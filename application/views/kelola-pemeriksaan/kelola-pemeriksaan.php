                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <?php if ($val2['tl_tanggapan_publish_kabag']=="Y" AND $val2['tl_tanggapan_kirim']=="N"): ?>
                                                ...
                                                <?php echo "<a href='".base_url()."administrator/kirim_tanggapan/$id_pmr/$val2[temuan_id]/$val2[rekomendasi_id]/$val2[tl_id]'>" ?><button type="button" class="btn btn-xs btn-success" data-toggle="modal" data-placement="top" title="Kirim Tanggapan ke Regional/Divisi" <?php echo $disable; ?>><span class="fa fa-send-o"></span></button></a>
                                    ...
                                    <table class="table table-bordered">
                                      ...
                                      <tbody>
                                        ...
                                        <?php if ($baris['tl_tanggapan_publish_kabag']=="Y" AND $baris['tl_tanggapan_kirim']=="N"): ?>
                                                ...
                                                <?php echo "<a href='".base_url()."administrator/kirim_tanggapan/$id_pmr/$value[temuan_id]/$row[rekomendasi_id]/$baris[tl_id]'>" ?><button type="button" class="btn btn-xs btn-success" data-toggle="tooltip" data-placement="top" title="Kirim Tanggapan ke Regional/Divisi" <?php echo $disable; ?>><i class="fa fa-send-o"></i></button></a>
