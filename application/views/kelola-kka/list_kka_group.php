                    ...
                    <table id="datatable" class="table table-striped table-bordered table-hover">
                      ...
                      <?php 
                        ...
                        <tr>
                          ...
                          <td>
                            <?php echo "<a href='".base_url()."administrator/detail_kka/$row[pemeriksaan_id]'>"?>
                              <button type="button" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="top" title="Detail Data KKA" <?php  echo strpos($role[0]['role_akses'],',6,')!==FALSE?"":"disabled"; ?>><span class="fa fa-info"></span>&nbsp;Detail</button></a>
                            <?php $no++; }?>
                          </td>
                        </tr>
                      </tbody>
