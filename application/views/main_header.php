              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img <?php if ($usr['user_foto']!=null) { ?>src="<?php echo base_url(); ?>asset/foto_user/<?php echo $usr['user_foto'] ?>"<?php }else{ ?>src="<?php echo base_url() ?>/asset/images/user.png"<?php } ?> alt=""><?php $level = ($usr['user_level'] == 'kabagspi') ? 'KADIV' : $usr['user_level']; echo $usr['user_nama'] . " - " . $level; ?>
