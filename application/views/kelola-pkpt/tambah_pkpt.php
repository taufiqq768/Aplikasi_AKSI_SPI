       ...
       <div class="">
         ...
         <div class="row">
           <div class="col-md-10 col-sm-10 col-xs-12">
             <div class="x_panel">
                 <div class="x_title">
                   <h2><a href="<?php echo base_url(); ?>administrator/list_pkpt"><button type="button" class="btn btn-default btn-xs"><i class="fa fa-mail-reply"></i></button></a>
                     Form Tambah PKPT <small></small></h2>
                 ...
                 <?php 
                   ...
                   echo form_open('administrator/input_pkpt',$attributes);
                 ?> 
                 ...
                 <div class="form-group">
                   ...
                   <div class="form-group">
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12">
                       <input type="text" id="jumlah" required="required" name="jumlah" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('jumlah'); ?>">
                     </div>
                   </div>
                   <div class="form-group">
