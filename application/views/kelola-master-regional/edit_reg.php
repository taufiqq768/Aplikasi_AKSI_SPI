<title>PTPN XII | Edit Regional</title>
        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-9 col-sm-9 col-xs-12">
              <div class="x_panel">
                  <div class="x_title">
                    <h2>Form Edit Regional <small></small></h2>
                  ...
                  <?php 
                    ...
                    echo form_open('administrator/edit_reg/'.$this->uri->segment(3),$attributes);
                  ?>
                      <?php foreach ($record as $row) { 
                        echo "<div class='form-group'><input type='hidden' name='id' value='$row[unit_id]'></div>";
                      ?>
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12">
                       <input type="text" id="regional" required="required" name="regional" class="form-control col-md-7 col-xs-12"  value="<?php echo $row['unit_nama'] ?>">
                     </div>
                   </div>
                        <?php } ?>
