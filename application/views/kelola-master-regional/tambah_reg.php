       ...
       <div class="">
         ...
         <div class="row">
           <div class="col-md-10 col-sm-10 col-xs-12">
             <div class="x_panel">
                 <div class="x_title">
                   <h2><a href="<?php echo base_url(); ?>administrator/list_reg"><button type="button" class="btn btn-default btn-xs"><i class="fa fa-mail-reply"></i></button></a>
                     Form Master Regional <small></small></h2>
                 ...
                 <?php 
                   ...
                   echo form_open('administrator/input_reg',$attributes);
                 ?>
                   <div class="form-group">
                     <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Nama Regional <span class="required ">*</span></label>
                     <div class="col-md-6 col-sm-6 col-xs-12">
                       <input type="text" id="regional" required="required" name="regional" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('regional'); ?>">
                     </div>
                   </div>
                     <?php 
