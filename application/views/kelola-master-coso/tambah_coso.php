       ...
       <div class="">
         <div class="page-title">
           <div class="title_left">
             <h3>Tambah Data Klasifikasi COSO</h3>
              <?php //if ($pesan!='') {
             ...
             <div class="x_panel">
                 <div class="x_title">
                   <h2><a href="<?php echo base_url(); ?>administrator/list_coso"><button type="button" class="btn btn-default btn-xs"><i class="fa fa-mail-reply"></i></button></a>
                     Form Pendaftaran Klasifikasi COSO <small></small></h2>
                 ...
                 <?php 
                   ...
                   echo form_open('administrator/input_coso',$attributes);
                 ?>
                   ...
                   <div class="form-group">
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12">
                       <input type="text" id="coso" required="required" name="coso" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('coso'); ?>">
                     </div>
                   </div>
                     <?php 
