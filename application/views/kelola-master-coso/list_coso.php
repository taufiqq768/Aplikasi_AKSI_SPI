          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>List Klasifikasi COSO<small>(AKSI)</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <?php $role = $this->model_app->view_where('tb_role','role_id',$this->session->role);?>
                      <a href="./input_coso"><li><button type="button" class="btn btn-default btn-xs" <?php  echo strpos($role[0]['role_akses'],'15')!==FALSE?"":"disabled"; ?>>Tambah Data</button></a></li></a>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?php echo $no; ?></td>
                          <td><?php echo $row['kode_coso']; ?></td>
                          <td><?php echo $row['klasifikasi_coso']; ?></td>
                          <td>  <center>
                            <?php   echo "<a href='".base_url()."administrator/edit_coso/$row[coso_id]'"?><button type="button" class="btn btn-primary btn-xs" title="Edit Temuan" <?php  echo strpos($role[0]['role_akses'],'16')!==FALSE?"":"disabled"; ?>><i class="fa fa-edit"></i> Edit</a></button></center>
