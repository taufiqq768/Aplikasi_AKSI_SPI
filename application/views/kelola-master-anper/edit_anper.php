<title>PTPN XII | Edit Anak Perusahaan PTPN I</title>
        ...
        <div class="">
          <div class="page-title">
            <div class="title_left">
              <h3>Edit Informasi Anak Perusahaan PTPN I</h3>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-9 col-sm-9 col-xs-12">
              <div class="x_panel">
                  <div class="x_title">
                    <h2>Form Edit Anak Perusahaan PTPN I <small></small></h2>
                  ...
                  <?php 
                    ...
                    echo form_open('administrator/edit_anper/'.$this->uri->segment(3),$attributes);
                  ?>
                      <?php foreach ($record as $row) { 
                        echo "<div class='form-group'><input type='hidden' name='id' value='$row[anper_id]'></div>";
                      ?>
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12">
                       <input type="text" id="anper" required="required" name="anper" class="form-control col-md-7 col-xs-12"  value="<?php echo $row['anper_nama'] ?>">
                     </div>
                   </div>
                        <?php } ?>
