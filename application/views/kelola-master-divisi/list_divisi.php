<title>PTPN XII | List Klasifikasi COSO</title>
        <!-- page content -->
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Master Divisi<small>(AKSI)</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <?php $role = $this->model_app->view_where('tb_role','role_id',$this->session->role);?>
                      <a href="./input_divisi"><li><button type="button" class="btn btn-default btn-xs" <?php  echo strpos($role[0]['role_akses'],'15')!==FALSE?"":"disabled"; ?>>Tambah Data</button></a></li></a>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th style="width: 5%">Kode Divisi</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?php echo $no; ?></td>
                          <td><?php echo $row['master_bagian_nama']; ?></td>
                          <td><?php echo $row['master_bagian_kode']; ?></td>
                          <td>  <center>
                            <?php   echo "<a href='".base_url()."administrator/edit_divisi/$row[master_bagian_id]'"?><button type="button" class="btn btn-primary btn-xs" title="Edit Temuan" <?php  echo strpos($role[0]['role_akses'],'16')!==FALSE?"":"disabled"; ?>><i class="fa fa-edit"></i> Edit</a></button></center>
