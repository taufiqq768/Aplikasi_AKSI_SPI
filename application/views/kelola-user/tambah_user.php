 <title>PTPN XII | Tambah User </title>
        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-10 col-sm-10 col-xs-12">
              <div class="x_panel">
                  <div class="x_title">
                    <h2><a href="<?php echo base_url(); ?>administrator/list_user"><button type="button" class="btn btn-default btn-xs"><i class="fa fa-mail-reply"></i></button></a>
                      Form Pendaftaran User <small></small></h2>
                  ...
                  <?php 
                    ...
                    echo form_open('administrator/input_user',$attributes);
                  ?>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="nik" required="required" name="nik" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('nik'); ?>">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="nama" required="required" name="nama" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('nama'); ?>">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="judul_pmr" name="email" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('email'); ?>">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Password <span class="required ">*</span></label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="password" id="password" required="required" name="password" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('password'); ?>">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Konfirmasi Password <span class="required ">*</span></label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="password" required="required" name="confirm_password" id="confirm_password" value="<?php echo set_value('confirm_password'); ?>" class="form-control col-md-7 col-xs-12">
                      </div>
                      <?php 
                  ...
                  <div class="form-group">
                   ...
                   <div class="col-md-6 col-sm-6 col-xs-12">
                     <select id="unit" class="select2_single form-control" name="unit">
                      <option></option>
                       <?php foreach ($record2 as $value) { ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <select id="heard" class="form-control" name="level" required>
                        ...
                        <option value="administrasi">Admin (administrasi)</option>
                        <option value="spi">Petugas SPI</option>
                        <option value="kabagspi">Kabag SPI</option>
                 ...
                 <div class="form-group">
                   ...
                   <div class="col-md-6 col-sm-6 col-xs-12">
                     <select id="heard" class="form-control" name="role" required>
                       ...
                       <option value="<?php echo $value['role_id'] ?>"><?php echo $value['role_nama']; ?></option>
                       <?php } ?>
                     </select>
                   </div>
                 </div>
